...
- (void)setupSubviews{
    ...
    if (KSGuaidManager.shouldDismissWhenDragging == NO) {
        ...
        self.dismissButton.layer.borderColor = HEXColor(@"#FF7627", 1).CGColor;
        [self.dismissButton setTitle:@"立即体验" forState:UIControlStateNormal];
        [self.dismissButton setTitleColor:HEXColor(@"#FF7627", 1) forState:UIControlStateNormal];
        [self.dismissButton.titleLabel setFont:[UIFont systemFontOfSize:16]];
        self.dismissButton.frame = CGRectMake(0, 0, 140 ,40);
...
- (void)viewDidLayoutSubviews{
    ...
    self.dismissButton.top = self.dismissButton.top + 10;
}
