...
//-(void)countDownWithStratDate:(NSDate *)startDate finishDate:(NSDate *)finishDate completeBlock:(void (^)(NSString *day,NSString *hour,NSString *minute,NSString *second))completeBlock;
///用时间戳倒计时
